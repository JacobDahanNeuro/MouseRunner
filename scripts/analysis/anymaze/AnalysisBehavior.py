...
def AnalysisBehavior(GUI=True,archive=True,load_archive=False,archive_only=False,\
    ...
    """
    MatchedFiles, data_constants = Handler.grab_files(GUI,load_archive,archive_only,data_ids,\
    ...
    Analysis = Classes.AnalysisContainer(MatchedFiles,data_ids,data_types,\
                                         data_constants,similar_group_ids,\
...
# Analysis.filter_mice(which='Freezing',by='baseline_freezing',criteria=['0.4'])
Analysis.filter_mice(which='Freezing',by='mouse_id',criteria=['034399'])
Analysis.filter_trials(which='Freezing',by='trialized_freezing',criteria=0.8)
# Analysis.normalize(which='Freezing',by='pre',scale=True,scale_by=0,scale_to=1)
Analysis.normalize(which='Freezing',by='baseline',scale=True,scale_by=0,scale_to=1)
